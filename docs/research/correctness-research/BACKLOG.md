...
## Entry Chamber and Player Spawn — DONE

**Fixed in c5f4169.** Dungeon name propagation, TILE_START handling, entry coordinates, and player placement all implemented. See cross-cutting-flows.md Flows 1 and 8.
